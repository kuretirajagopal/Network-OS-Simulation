...
int main()
{
    ...
    system(("echo 'jaya_krishna' > " + d1 + "/file1").c_str());
    system(("echo 'Raja_Gopal' > " + d1 + "/file2").c_str());

    system(("mkdir " + d2).c_str());
    system(("echo 'Chenna_Keshava' > " + d2 + "/file3").c_str());
    system(("echo 'Souhardya_Halder' > " + d2 + "/file4").c_str());
